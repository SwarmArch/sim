...
Address SetAssocArray::reverseLookup(uint32_t lineId) const {
    return array[lineId];
}
...
Address ZArray::reverseLookup(uint32_t lineId) const {
    return array[lineId];
}
